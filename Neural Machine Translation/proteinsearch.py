...
from model.proteinsearch import proteinsearch, beamsearch, batchsample, evaluate_model
...
def parseargs_train(argv):
    msg = "training proteinsearch"
    usage = "proteinsearch.py train [<args>] [-h | --help]"
...
def parseargs_decode(args):
    ...
    usage = "proteinsearch.py translate [<args>] [-h | --help]"
    parser = argparse.ArgumentParser(description=msg, usage=usage)
...
def parseargs_sample(args):
    ...
    usage = "proteinsearch.py sample [<args>] [-h | --help]"
    parser = argparse.ArgumentParser(description=msg, usage=usage)
...
def parseargs_replace(args):
    ...
    usage = "proteinsearch.py replace [<args>] [-h | --help]"
    parser = argparse.ArgumentParser(description=msg, usage=usage)
...
def parseargs_evaluate(args):
    ...
    usage = "proteinsearch.py evaluate [<args>] [-h | --help]"
    parser = argparse.ArgumentParser(description=msg, usage=usage)
...
def helpinfo():
    print("usage:")
    print("\tproteinsearch.py <command> [<args>]")
    print("use 'proteinsearch.py train --help' to see training options")
    print("use 'proteinsearch.py translate' --help to see decoding options")
    print("use 'proteinsearch.py sample' --help to see sampling options")
    print("use 'proteinsearch.py replace' --help to see UNK replacement options")
    print(("use 'proteinsearch.py evaluate --help' to see evaluation options"))
